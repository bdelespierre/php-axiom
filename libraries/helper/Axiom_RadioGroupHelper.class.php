 ...
 * @subpackage helper
 */
class Axiom_RadioGroupHelper extends Axiom_BaseHelper {
     ...
     * @param string $label
     * @param scalar $value
     * @return Axiom_RadioGroupHelper
     */
    public function addOption ($label, $value) {
        $this->_children[] = Axiom_InputHelper::export($this->_name, 'radio', $value)->setId($id = 'radio' . (self::$_count ++));
