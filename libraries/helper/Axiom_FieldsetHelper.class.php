 ...
 * @subpackage helper
 */
class Axiom_FieldsetHelper extends Axiom_BaseHelper {
    ...
    public function addLine ($name, $display_name = null, $type = "text", $value = "", $class = "") {
        $this->appendChild($this->_fieldset_lines[$name] = Axiom_FormLineHelper::export($name, $display_name, $type, $value, $class));
        return $this;
    }
