 ...
 * where commands are instance of Axiom_Logger.
 *
 * @author Delespierre
 * @package libaxiom
 * @subpackage log
...
class Axiom_Log {
    ...
    public static function error ($msg) {
        self::message($msg, Axiom_Logger::ERR);
    }
    ...
    public static function notice ($msg) {
        self::message($msg, Axiom_Logger::NOTICE);
    }
    ...
    public static function warning ($msg) {
        self::message($msg, Axiom_Logger::WARNING);
    }
    ...
    public static function debug ($msg, array $bt = array()) {
        ...
        self::message($msg, Axiom_Logger::DEBUG);
    }
    
    /**
     * Attach a logger to the chain
     * @param Axiom_Logger $logger
     * @return void
     */
    public static function addLogger (Axiom_Logger $logger) {
        if (!isset(self::$_first))
