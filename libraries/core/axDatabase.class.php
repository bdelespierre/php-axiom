...
class axDatabase {
    ...
    /**
     * The axDatabase class cannot be instanciated
     * @internal
     */
        ...
        try {
            ...
            if (!$ignore_error) {
                if (PHP_VERSION_ID >= 50300)
                    throw new RuntimeException("axDatabase connection error", 2032, $e);
                else
                    throw new RuntimeException("axDatabase connection error", 2032);
            }
            return false;
        }
    }
