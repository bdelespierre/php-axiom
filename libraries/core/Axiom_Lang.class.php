...
class Axiom_Lang {
    ...
    public static function loadLanguage ($lang_file = null) {
        ...
        if (!is_file($lang_file)) {
            throw new Axiom_MissingFileException($lang_file, 2029);
        }
...
function i18n ($key) {
    $args = func_get_args();
    switch (count($args)) {
        case 1: return Axiom_Lang::i18n($args[0]); break;
        case 2: return Axiom_Lang::i18n($args[0], $args[1]); break;
        case 3: return Axiom_Lang::i18n($args[0], $args[1], $args[2]); break;
        case 4: return Axiom_Lang::i18n($args[0], $args[1], $args[2], $args[3]); break;
        case 5: return Axiom_Lang::i18n($args[0], $args[1], $args[2], $args[3], $args[4]); break;
...
function format_date ($date) {
    return Axiom_Lang::formatDate($date);
}
