...
class Axiom_Database {
    ...
    /**
     * The Axiom_Database class cannot be instanciated
     * @internal
     */
        ...
        try {
            ...
            if (!$ignore_error) {
                if (PHP_VERSION_ID >= 50300)
                    throw new RuntimeException("Axiom_Database connection error", 2032, $e);
                else
                    throw new RuntimeException("Axiom_Database connection error", 2032);
            }
            return false;
        }
    }
