...
class axLang {
    ...
    public static function loadLanguage ($lang_file = null) {
        ...
        if (!is_file($lang_file)) {
            throw new axMissingFileException($lang_file, 2029);
        }
...
function i18n ($key) {
    $args = func_get_args();
    switch (count($args)) {
        case 1: return axLang::i18n($args[0]); break;
        case 2: return axLang::i18n($args[0], $args[1]); break;
        case 3: return axLang::i18n($args[0], $args[1], $args[2]); break;
        case 4: return axLang::i18n($args[0], $args[1], $args[2], $args[3]); break;
        case 5: return axLang::i18n($args[0], $args[1], $args[2], $args[3], $args[4]); break;
