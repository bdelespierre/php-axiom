...
class Axiom_ModuleManager {
     ...
     * @return Axiom_DirectoryFilterIterator
     */
    public static function getAvailableModules () {
        $dir = new DirectoryIterator(self::$_config['module_path']);
        return new Axiom_DirectoryFilterIterator($dir);
    }
    ...
    public static function load ($module) {
        ...
        Axiom_Log::debug("Loading module {$module}");
        Axiom_Log::debug("Module infs " . json_encode($module_inf));
    ...
    public static function checkUpdates ($module) {
        // TODO Axiom_ModuleManager::checkUpdates
    }
