 ...
 * Axiom_Mail::addPart but keep the text
 * part as first part.
 *
 * @author Delespierre
 * @package libaxiom
...
class Axiom_Mail {
     ...
     *
     * Header must be part of Axiom_Mail::$valid_headers.
     ...
     * for part removal with Axiom_Mail::removeMessagePart).
     *
     * @param string $message
    ...
    public function addAttachment ($path, $content_type = null, $filename = null) {
        if (!is_file($path))
            throw new Axiom_MissingFileException($path, 2024);
    ...
    /**
     * Alias of Axiom_Mail::removeMessagePart
     * @see Axiom_Mail::removeMessagePart
     * @param string $key
     * @return voic
     */
