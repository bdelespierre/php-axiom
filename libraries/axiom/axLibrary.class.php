...
class axLibrary {
     ...
     */
    public function __construct ($lib_path = "", $app_path = "", $extension = ".class.php") {
    ...
    public function add ($name) {
        ...
        if (!set_include_path($dir . PATH_SEPARATOR . get_include_path()))
    ...
    /**
     * @brief Loads a given class
     * @param string $classname
     * @return boolean
     */
    public function load ($classname) {
        return include "{$classname}{$this->_extension}";
    }
}