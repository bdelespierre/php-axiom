 ...
 * @subpackage feed
 */
class Axiom_Feed extends ArrayIterator {
     ...
     * it manually, an empty Axiom_FeedEntry will be created
     * and returned so you can manipulate it.
     *
     * @param Axiom_FeedEntry $entry
     * @return Axiom_FeedEntry
     */
    public function add (Axiom_FeedEntry $entry = null) {
        if (!$entry)
            $entry = new Axiom_FeedEntry;
    ...
    public function setAuthor (array $author) {
        ...
        if (isset($author['mail']) && !Axiom_Mail::validateEmail($author['mail']))
    ...
    public function build ($type = null) {
        ...
        if (!$reflextion->isSubclassOf("Axiom_FeedWriter"))
            throw new RuntimeException("$class must extends Axiom_FeedWriter", 4018);
