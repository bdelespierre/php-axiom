 ...
 * @subpackage feed
 */
class Axiom_AtomFeedWriter extends Axiom_FeedWriter {
    
    /**
     * Default constructor
     * @param Feed $feed
     */
    public function __construct (Axiom_Feed $feed) {
    ...
    /**
     * (non-PHPdoc)
     * @see Axiom_FeedWriter::buildFeedInfo()
     */
    ...
    /**
     * (non-PHPdoc)
     * @see Axiom_FeedWriter::buildItems()
     */
